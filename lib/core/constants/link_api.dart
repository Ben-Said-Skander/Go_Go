class LinkApi {
  static const String server = "http://192.168.1.16:3600";

  static const String register = "$server/register";
  static const String user = "$server/user";
  static const String post = "$server/post";
  ...
  static const String updateAvailable = "$server/user/updateAvailable";
  static const String updateDestination = "$server/user/updateDestination";
  static const String updateCar = "$server/user/updateCar";
